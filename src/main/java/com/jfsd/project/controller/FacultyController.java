...
public class FacultyController {
    ...
    @GetMapping("/fviewall")
    public ModelAndView fviewfeedback() {
        // Fetch all feedback
        List<StudentResponse> feedbackresp = feedbackService.getAllFeedback();

        // Create ModelAndView object
        ModelAndView modelAndView = new ModelAndView("fviewall");
        modelAndView.addObject("feedbackresp", feedbackresp);

        return modelAndView; 
    }

    @GetMapping("/fviewanswers")
    public ModelAndView fviewfeedback(@RequestParam("facultyId") int facultyId) {
        // Fetch feedback responses by facultyId
        List<StudentResponse> feedbackresp = feedbackService.getAllFeedbackAnswers(facultyId);

        // Create ModelAndView object
        ModelAndView modelAndView = new ModelAndView("fviewanswers");
        modelAndView.addObject("responses", feedbackresp);
